...
TrueWater_game_width = view_wview[TrueWater_room_view];
TrueWater_game_height = view_hview[TrueWater_room_view];
aspect_ratio_x = TrueWater_game_width / view_wview[TrueWater_room_view];
aspect_ratio_y = TrueWater_game_height / view_hview[TrueWater_room_view];
